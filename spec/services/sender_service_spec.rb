...
describe SenderService, type: :service do
  let(:user) { User.new }
  ...
  context '#send_request_for_session_token' do
    ...
    it 'should set up some cookie' do
      ...
      expect(session.session).not_to be_nil
      expect(session.lang).not_to be_nil
    end
  end
  ...
  context '#send_first_post_request' do
    it 'should set up cookie' do
      SenderService.send_request_for_session_token(session)
      cookie = SenderService.send_first_post_request(user, session)
  ...
  context '#send_request_for_guid' do
    it 'should return guid' do
      ...
      expect(session.guid).not_to be_nil
    end
  end
  ...
  context '#send_ajax_req_for_train_pixels' do
    it 'should return json with info about pixels' do
      ...
      SenderService.send_request_for_guid(params_for_request, session)
      free_places_hash = SenderService.send_ajax_req_for_free_places_hash(session)
      second_ajax_resp = SenderService.send_ajax_req_for_train_pixels(free_places_hash, session)
  ...
  context '#send_request_with_seat_info' do
    it 'should return json with info about pixels' do
      ...
      free_places_hash = SenderService.send_ajax_req_for_free_places_hash(session)
      second_ajax_resp = SenderService.send_ajax_req_for_train_pixels(free_places_hash, session)
      response = SenderService.send_request_with_seat_info(free_places_hash, second_ajax_resp, session)
  ...
  context '#send_passanger_info' do
    it 'should return OK status' do
      ...
      free_places_hash = SenderService.send_ajax_req_for_free_places_hash(session)
      second_ajax_resp = SenderService.send_ajax_req_for_train_pixels(free_places_hash, session)
      SenderService.send_request_with_seat_info(free_places_hash, second_ajax_resp, session)
      response = SenderService.send_passanger_info(session)

      expect(session.order_basket_id).to_not be_nil
    end
  end
end
