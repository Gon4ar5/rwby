...
def send_second_get_req(cookie)
...
def get_route_params
  ...
  set_request_cookie_header(request)
...
def send_request_for_guid(params_for_request)
...
def send_ajax_req_for_free_places_hash
  ...
  add_default_headers(request, add_addtl_headers: true)
  request["Accept"] = "*/*"
...
def send_ajax_req_for_train_pixels(free_places_hash)
...
def send_request_with_seat_info(free_places_hash, second)
  ...
  set_request_cookie_header(request, guid_required: true)
